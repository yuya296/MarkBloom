...
- ライブラリ実装(tabulator/jspreadsheet): 基本機能は高いが、table editor UIへ寄せる際に内部DOM/CSS依存が増えやすい
という課題があった。

今回の狙いは「シンプルな table editor 体験」を
長期保守性を保ちながら実現すること。
...
## References
- docs/features/014-cm6-table-editor/spec.md
- docs/features/014-cm6-table-editor/tasks.md
